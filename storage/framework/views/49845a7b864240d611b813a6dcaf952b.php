...
<div class="container my-4">
    ...
    <form action="<?php echo e(route('banding.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>

        <!-- Rincian Data Pemohon Sertifikasi -->
        <div class="card mb-4 p-3">
            <div class="avatar-imgs mb-3" >
    <img src="<?php echo e(asset('assets/poto/potta.png')); ?>" alt="Potta" class="img-fluid" style="align-items: center;">
            </div>
    ...
    <h4 class="text-center mb-4">Banding Asesmen</h4>
            ...
            <div class="mb-3">
                ...
                <input type="text" id="asesor" class="form-control"
                    value="<?php echo e(session('asesor')); ?>" readonly>
            </div>

            <div class="mb-3">
                <label for="tanggal" class="form-label">Tanggal</label>
                <input type="date" id="tanggal" class="form-control"
                    value="<?php echo e(session('tanggal')); ?>" readonly>
            </div>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LSP-PROJECT\resources\views/banding-asesmen.blade.php ENDPATH**/ ?>