<?php $__env->startSection('title', 'FR.APL.02 - Permohonan Sertifikasi Kompetensi'); ?>
...
<div class="container mt-2 my-5">
    <div class="bg-white border rounded-3 shadow-sm p-4">
        ...
        <!-- Form -->
        <form id="permohonanForm" action="<?php echo e(route('asesi.permohonan.storeDokumen')); ?>" method="POST"
            ...
            <div class="border rounded-3 p-3 mb-4">
                ...
                <div class="mb-3">
                    ...
                    <select id="skemaSelect" name="id_skema" class="form-select rounded-3" required>
                        ...
                        <?php $__currentLoopData = $skema; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($s->id_skema); ?>"><?php echo e($s->nama_skema); ?></option>
            ...
            <div class="border rounded-3 p-3 mb-4">
                ...
                <?php $__currentLoopData = $jenisDokumen; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="mb-3">
                        <label class="form-label"><?php echo e($loop->iteration); ?>. <?php echo e($jd->nama_jenis); ?> <span class="text-danger">*</span></label>
                        <div class="input-group">
                            <input type="file" 
                                   name="dokumen[<?php echo e($jd->id_jenis_dokumen); ?>]" 
                ...
                <div class="card">
                    ...
                    <div class="mb-2">
                        ...
                        <input type="text" id="nama-asesi" class="form-control"
                               value="<?php echo e($asesi->nama_lengkap ?? ''); ?>" readonly>
                    </div>
                    <div class="mb-3">
            ...
            <div class="d-flex justify-content-end gap-2">
                <a href="<?php echo e(route('asesi.permohonan.form1')); ?>" class="btn btn-danger">Kembali</a>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LSP-PROJECT\resources\views/asesi/permohonan/form2.blade.php ENDPATH**/ ?>