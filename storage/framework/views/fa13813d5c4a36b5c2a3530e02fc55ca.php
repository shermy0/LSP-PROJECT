...
<div class="mb-4">
  <h2 class="fw-bold">
    Selamat Datang <?php echo e($asesi->nama_lengkap ?? $user->name); ?>

  </h2>
  <p class="text-muted mb-1">
    <?php echo e($asesi->jurusan ?? 'Rekayasa Perangkat Lunak'); ?>

  </p>
  <span class="phone">
    <?php echo e($asesi->telepon ?? 'Nomor HP belum diisi'); ?>
...
<?php echo $__env->make('master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LSP-PROJECT\resources\views/asesi/dashboard.blade.php ENDPATH**/ ?>