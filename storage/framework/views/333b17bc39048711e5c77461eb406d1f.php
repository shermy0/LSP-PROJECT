...
<body>
                    ...
                    <tr>
                        ...
                        <td>
                            <label class="upload-btn">
                                ...
                                <script src="<?php echo e(asset('assets/js/asesmen.js')); ?>"></script>
                            </label>
    ...
    <div class="container button-group">
        <a href="<?php echo e(route('index')); ?>" class="btn-back">Kembali</a>
        <a href="<?php echo e(route('verifasesmen2')); ?>" class="btn-next" >Simpan dan Lanjut</a>
    </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\LSP-PROJECT\resources\views/asesor/verifasesmen.blade.php ENDPATH**/ ?>