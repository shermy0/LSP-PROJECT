...
<div class="container mt-4">
    <div class="text-center mb-4">
        ...
        <p class="text-muted">
            ...
            @if(isset($id_pembuatan) && $id_pembuatan)
...
const globalIdPembuatan = "{{ $id_pembuatan ?? '' }}";
const globalIdPmo       = "{{ $resolvedIdPmo }}";
const globalJudul       = "{{ addslashes($judul ?? '') }}";
...
@if(isset($id_pembuatan) && $id_pembuatan)
<a href="{{ route('tanda.tangan.asesmen', [$skema->id_skema, $id_pembuatan]) }}"
