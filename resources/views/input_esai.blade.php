...
<form action="{{ route('pertanyaan.esai.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            <textarea name="isi_pertanyaan[]" class="form-control mb-2" placeholder="Pertanyaan ke-{{ $i }}" required></textarea>
            <input type="text" name="kunci_jawaban[]" class="form-control" placeholder="Kunci jawaban">
        </div>
    </div>
    @endfor
