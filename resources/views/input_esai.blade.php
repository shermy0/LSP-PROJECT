...
<div class="container mt-4">
    ...
    <form id="formPertanyaanLisan" action="{{ route('pertanyaan.lisan.store') }}" method="POST">
        ...
        <!-- List pertanyaan -->
        <div id="daftarPertanyaanLisan" class="mt-3">
            @for ($i = 1; $i <= $jumlah; $i++)
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea 
                            ...
                            rows="2"
                            placeholder="Masukkan pertanyaan ke-{{ $i }}" 
                            required></textarea>
                    </div>
                    <div class="mb-2">
...
// Tambah pertanyaan baru ke form
function tambahPertanyaan(jumlahBaru) {
    for (let j = 1; j <= jumlahBaru; j++) {
        totalPertanyaan++;
        let div = document.createElement('div');
        div.classList.add('card', 'shadow-sm', 'mb-3', 'border-0', 'rounded-4');
        div.innerHTML = `
            <div class="card-body">
                <div class="mb-3">
