...
<div class="container mt-4">
   ...
   @isset($kelompok)
    @forelse($kelompok as $k)
        <div class="mb-4">
            <h5 class="fw-bold text-primary">{{ $k->nama_kelompok }}</h5>
                ...
                <div class="card mb-3 shadow-sm">
                    <div class="card-body">
                        ...
                        <div class="d-flex gap-2 mt-3">
                            <a href="{{ route('lisan.edit', $p->id_pertanyaan) }}" class="btn btn-sm btn-warning">
                                Edit
                            </a>
    ...
    @empty
        <p class="text-muted">Belum ada kelompok pekerjaan.</p>
    @endforelse
@endisset

{{-- fallback kalau pakai $pertanyaan --}}
@isset($pertanyaan)
