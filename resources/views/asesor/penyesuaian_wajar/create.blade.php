                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th>Keterangan (pilih yang sesuai)</th>
                            </tr>
                        </thead>
                        <tbody>
                            <!-- Item 1 -->
                            <tr>
                                ...
                                <td>
                                    <div class="row" id="keterangan-1">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-check">
                                                <input class="form-check-input item-checkbox" type="checkbox" name="items[1][keterangan][]" value="Mengunakan Ceklis observasi/demonstrasi." id="item1_ket4" disabled>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Fungsi untuk mengaktifkan/menonaktifkan checkbox berdasarkan radio yang dipilih
