        ...
        <div class="card-body">
            <ol class="list-group list-group-numbered">
                <li class="list-group-item border-0 ps-0">
                    Buatlah pertanyaan Pilihan Ganda yang dapat mengekplorasi penguasaan informasi pelaksanaan KUK, batasan variabel, pengetahuan dan keterampilan esensial, aspek penting kritis.
                </li>
                <li class="list-group-item border-0 ps-0">
...
<div class="modal fade" id="modalPertanyaan" tabindex="-1" aria-labelledby="modalPertanyaanLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 350px;">
        <div class="modal-content" style="border-radius: 10px; border: none;">
            ...
            <!-- Form Buat Baru -->
            <form method="GET" action="{{ route('pertanyaan.pg.kelompok', ['id_skema' => $skema->id_skema, 'jenis' => 'pilihan_ganda']) }}">
                <div class="modal-body pt-2">

                    <!-- Judul Pembuatan -->
                    <label for="judul" class="fw-bold small mt-2">Judul Pembuatan Pertanyaan</label>
                    <input type="text" name="judul" id="judul" class="form-control" placeholder="Contoh: Pilihan Ganda Skema A Batch 1" required>
...
function redirectToForm() {
    ...
    window.location.href = "{{ route('pertanyaan.pg.create') }}?jumlah=" + jumlah + "&id_skema=" + id_skema;
}
</script>
@endsection
