...
<div class="container mt-4">
    ...
    <div class="text-center mb-4">
        <h4 class="fw-bold" style="color:#041562;">Jawaban Hasil Ujian PMO</h4>
        ...
        <div class="card-body p-4">
            ...
            @empty
                <div class="text-center text-muted py-4">
                    ...
                    Belum ada set pertanyaan PMO.
                </div>
            @endforelse
        </div>
    </div>

    {{-- STEP 2: Pilih Kelompok (muncul setelah pilih pembuatan) --}}
    <div class="card shadow-sm border-0 rounded-4 mb-4" id="step2-card" style="display:none !important;">
        ...
        <div class="card-body p-4">
            <div class="row g-3" id="kelompok-list">
                        ...
                        <div class="card border-0 shadow-sm rounded-3 h-100"
                            ...
                            <div class="card-body px-4 py-3 d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">
                                        {{ $k->unitKompetensi->count() }} unit kompetensi
                                    </small>
                                </div>
...
function pilihPembuatan(id, judul, timer) {
    ...
    step2.style.removeProperty('display'); // override !important
...
function pergiKeJawaban(id_kelompok) {
    if (!selectedIdPembuatan) {
        alert('Pilih set pertanyaan terlebih dahulu.');
        return;
    }
    const id_skema = {{ $skema->id_skema }};
    window.location.href = `{{ url('/pmo/hasil') }}/${id_skema}/${selectedIdPembuatan}/${id_kelompok}`;
}
</script>

<style>
.pembuatan-card:hover {
    background-color: #f8f9ff !important;
    border-color: #041562 !important;
}
#step2-card .card:hover {
