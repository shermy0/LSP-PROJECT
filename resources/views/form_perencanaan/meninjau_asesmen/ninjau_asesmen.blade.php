...
<div class="card mapa-card">
    ...
    <div class="container mt-4">
        ...
        <!-- FORM UTAMA -->
        <form action="{{ route('form_perencanaan.meninjau_asesmen.ninjau_asesmen_asesor.store', ['id_skema' => $skema->id_skema]) }}" method="POST">
            @csrf
        ...
        <script>
            document.getElementById('skema_id').addEventListener('change', function() {
                ...
                document.getElementById("nama_asesor").addEventListener("change", function() {
