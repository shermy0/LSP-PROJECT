        ...
        <div class="card shadow-sm border-0 mb-4">
            ...
            <div class="card-body">
                ...
                @if(Auth::user()->role == 'asesi')
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p><strong>Keterangan/Catatan:</strong><br>{{ $permohonan->catatan ?? 'Tidak ada catatan' }}
                                        </p>
                                    </div>
                    ...
                    {{-- FR.APL.02 Asesmen Mandiri (hanya muncul jika Diterima) --}}
                    @if($status == 'Diterima')
                        @php
                        ...
                        <a href="{{ $asesmenLink }}"
                            ...
                            <div class="text-end"><span class="badge {{ $asesmenBadge }}">{{ $asesmenStatus }}</span></div>
                        </a>
                    @endif
                @endif

                {{-- Role Asesor dibiarkan sama --}}
                {{-- Jika role Asesor --}}
                @if(Auth::user()->role == 'asesor')
                    ...
                    {{-- FR.AK.07 Ceklis Penyesuaian --}}
                    <a href=""
                        class="pra-item d-flex justify-content-between align-items-center mb-3 p-3 text-decoration-none">
                        <div class="d-flex align-items-start">
                            <div class="icon-wrap me-3">📋</div>
                            <div>
                                <h6 class="mb-1 fw-semibold text-dark">FR.AK.07 Ceklis Penyesuaian Yang Wajar dan Beralasan</h6>
