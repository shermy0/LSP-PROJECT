    ...
    <div class="container position-relative" style="z-index: 10;">
        <div class="row justify-content-center text-center">
            <div class="col-lg-8 col-md-10">
                ...
                <!-- Badge estimasi -->
                <div class="d-inline-flex align-items-center gap-2 bg-white bg-opacity-70 px-4 py-2 rounded-pill shadow-sm mb-5" style="backdrop-filter: blur(5px); border: 1px solid rgba(11,47,124,0.1);">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#0b2f7c" class="bi bi-clock" viewBox="0 0 16 16">
                        <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71V3.5z"/>
                        <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16zm7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0z"/>
                    </svg>
                    <span class="text-secondary fw-medium">Estimasi verifikasi: 1-2 hari kerja</span>
                </div>
