...
@section('title', 'Admin - Detail Banding Asesmen')
...
<div class="container-fluid px-4 py-4">
    ...
    <div class="text-center mb-5">
        ...
        <p class="text-secondary">FR.AK.04 – Informasi lengkap pengajuan banding</p>
        ...
        <div class="card-body pt-3">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <p class="fw-semibold border p-2 rounded bg-light">{{ $banding->asesi->user->name ?? $banding->asesi->nama_asesi ?? '-' }}</p>
                </div>
                <div class="col-md-6">
        ...
        <div class="card-header bg-white border-0 pt-4 pb-0">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="text-secondary mb-0 small">Jawaban yang diberikan asesi</p>
                </div>
            </div>
        </div>
        <div class="card-body pt-3">
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label text-muted">1. Apakah Proses Banding telah dijelaskan?</label>
                    <p class="fw-semibold border p-2 rounded bg-light">{{ $banding->banding_dijelaskan ?? '-' }}</p>
                </div>
                <div class="col-md-6">
                    <label class="form-label text-muted">2. Apakah telah mendiskusikan dengan Asesor?</label>
                    <p class="fw-semibold border p-2 rounded bg-light">{{ $banding->diskusi_dengan_asesor ?? '-' }}</p>
                </div>
                <div class="col-md-6">
                    <label class="form-label text-muted">3. Apakah mau melibatkan orang lain?</label>
        ...
        <div class="card-header bg-white border-0 pt-4 pb-0">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="text-secondary mb-0 small">Penjelasan asesi</p>
                </div>
            </div>
        </div>
        <div class="card-body pt-3">
        ...
        <div class="card-header bg-white border-0 pt-4 pb-0">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="text-secondary mb-0 small">Bukti persetujuan asesi</p>
                </div>
            </div>
        </div>
        <div class="card-body pt-3">
                ...
                <div class="row">
                    <div class="col-md-6 text-center mx-auto">
                        <div class="border rounded p-3 bg-light">
                            ...
                            <img src="{{ asset('storage/' . $persetujuan->ttd_asesi) }}" alt="TTD Asesi" class="img-fluid mb-2" style="max-height: 150px;">
    ...
    <div class="button-group mt-4">
        <a href="{{ route('admin.banding-asesmen.index') }}" class="btn-back">
        ...
        <a href="{{ route('admin.banding-asesmen.download', $banding->id_banding) }}" class="btn-next" style="background: linear-gradient(135deg, #28a745, #1e7e34);">
