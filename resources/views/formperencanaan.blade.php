...
<li>
    <a href="{{ route('form_perencanaan.fr_va', ['periode' => 'saat', 'skema_id' => $skema->id_skema]) }}" 
       class="dropdown-item">
        FR.VA - Pada Saat Asesmen
    </a>
</li>
<li>
    <a href="{{ route('form_perencanaan.fr_va', ['periode' => 'sesudah', 'skema_id' => $skema->id_skema]) }}" 
       class="dropdown-item">
        FR.VA - Setelah Asesmen
    </a>
</li>
            </ul>
        </div>
